(function () {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const activatePublishCharacteristicsPanel = (detail = {}) => {
            ...
            publishCharacteristicsPanel.dataset.locationCountry = (detail.location && detail.location.country) || '';
            publishCharacteristicsPanel.dataset.locationStreet = (detail.location && detail.location.street) || '';
            publishCharacteristicsPanel.dataset.locationState = (detail.location && detail.location.state) || '';
            publishCharacteristicsPanel.dataset.locationCity = (detail.location && detail.location.city) || '';

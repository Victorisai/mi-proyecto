(function () {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const activatePublishLocationPanel = (detail = {}) => {
            ...
            publishLocationPanel.dataset.publishCountry = detail.country || '';
            publishLocationPanel.dataset.publishStreet = detail.street || '';
            publishLocationPanel.dataset.publishState = detail.state || '';
            publishLocationPanel.dataset.publishCity = detail.city || '';
        ...
        const activatePublishCharacteristicsPanel = (detail = {}) => {
            ...
            publishCharacteristicsPanel.dataset.publishCountry = detail.country || '';
            publishCharacteristicsPanel.dataset.publishStreet = detail.street || '';
            publishCharacteristicsPanel.dataset.publishState = detail.state || '';
            publishCharacteristicsPanel.dataset.publishCity = detail.city || '';
